...
%
%    M_CONTFBAR(BAX,...) where BAX is and axis handle draws the colourbar
%    for that axis.
%
%    Calling CONTFBAR a second time will replace the first colourbar.
%    Calling CONTFBAR without arguments will erase a colourbar.
%
%    See also COLORBAR
...
[~,h]=contourf(fakex,fakey,fakedata,Levels,'clipping','off');
