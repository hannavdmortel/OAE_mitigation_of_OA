...
% function [DATA,HEADERS,NICEHEADERS]=CO2SYS_v21(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS);
function [DATA,HEADERS,NICEHEADERS]=CO2SYS_v21_PF87(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS,KFCONSTANT);

% - - -
% Modified by Greg Pelletier 02-Jan-2025 for optional KF using Perez and Fraga 1987 instead of Dickson and Riley 1979
% for consistency with methods used by Jiang et al 2023
%	KFCONSTANT:
%   1 = KF of Dickson and Riley, 1979	(original default method in CO2SYS v21)											
%	2 = KF of Perez and Fraga, 1987 (method used by Jiang et al 2023, ill defined for low salinity. To be used for S: 10-40, T: 9-33)
% - - -
...
%        ...K1K2CONSTANTS,KSO4CONSTANTS,KFCONSTANT)
% 
%  **** SYNTAX EXAMPLES:
...
%
%  (*****) Each element must be an integer that 
%         indicates the KF dissociation constant that is to be used,
%   1 = KF of Dickson and Riley, 1979	(default method in CO2SYS v21)											
%	2 = KF of Perez and Fraga, 1987 (method used by Jiang et al 2023, ill defined for low salinity. To be used for S: 10-40, T: 9-33)
...
global pHScale WhichKs WhoseKSO4 WhichKF Pbar
...
clear global FugFac KB KS Pdbaro T TSi WhichKs WhichKF pHScale 
...
global pHScale WhichKs WhichKF WhoseKSO4 sqrSal Pbar RT;
